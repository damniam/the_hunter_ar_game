namespace TheHunter.Unity.Location
{
    ...
    public class DeviceLocationProvider : AbstractLocationProvider
    {
        ...
        private ITheHunterLocationService _locationService;
        ...
        protected virtual void Awake()
        {
            ...
            if (_editorDebuggingOnly._mockUnityInputLocation)
            {
                ...
                _locationService = new TheHunterLocationServiceMock(_editorDebuggingOnly._locationLogFile.bytes);
            }
            else
            {
#endif
                _locationService = new TheHunterLocationServiceUnityWrapper();
#if UNITY_EDITOR
            }
#endif
