...
namespace TheHunter.Unity.Location
{
    ...
    /// </summary>
    public class TheHunterLocationServiceMock : ITheHunterLocationService, IDisposable
    {


        public TheHunterLocationServiceMock(byte[] locationLogFileContents)
        {
        ...
        public ITheHunterLocationInfo lastData
        {
            get
            {
                if (null == _locationEnumerator) { return new TheHunterLocationInfoMock(); }
                ...
                return new TheHunterLocationInfoMock(currentLocation);
            }
        }
